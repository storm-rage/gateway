...
export default function EditRulePoint(props: IProps) {
  ...
  const changed = (e) => {
    // 光标没有在规则输入框时，选择无效
    console.log(cursorInfo,'===cursorInfo',e,dataSource)
          ...
          <div className="rule-point-ls">
            {dataSource?.map((i) => {
              return (
                ...
                <div className="rule-point-item" onClick={handleRulePointClick(i)}> 

 ...
 * @LastEditTime: 2024-12-18 17:22:51
 * @Description:
 */
import "./index.less"
...
export default function DeviceManage() {
  ...
  const openMenu = useRef((record: IUserList) => {
    console.log(record, "艰苦撒旦解放了")
  })
  return (
    <div className="page-wrap l-full setting-user">
      <CustomForm
        ref={formRef}
        loading={loading}
      ...
      <CustomTable
        ...
        limitHeight
        loading={loading}
        columns={DEVICE_ATT_COLUMNS({ onClick: onTbAction }, openMenu.current)}

 ...
 * @LastEditTime: 2025-06-05 10:18:13
 * @Description:
 */
...
import { IUserList, IUserListParam } from "../types"
...
export async function getSettingUserSchData(pageInfo: IPageInfo) {
  const res = await doNoParamServer<IUserList[]>("getRoleUser")
...
export const addUserMethods = async (data: any, type: TModalType) => {
  const api = type == "add" ? "addRole" : "updateRole"

...
const currentRolePermission = [
  ...
  "model:deviceSplit:search",
  "model:deviceSplit:add",
  "model:deviceSplit:edit",
  "model:deviceSplit:batchDelete",
  "model:deviceSplit:template",
  "model:deviceSplit:export",
  "model:deviceSplit:import",
  "model:pageIndex",
  "model:realtimeData",
  "model:configManage",
  "model:configStation",
  "model:configDeviceModel",
  "model:configDeviceAttr",
  "model:configDeviceAgreement",
  "model:configDevicePoint",
  "model:configDevicePointAddress",
  "model:configDeviceSplit",
  "model:dataForward",
  "model:systemManage",
  "model:businessConstant",

  "gateway:pageIndex",
  "gateway:realtimeData",
  "gateway:configManage",
  "gateway:dataForward",
  "gateway:systemManage",
  ...
  "rule:time:search",
  "rule:virtual:add",
  "rule:virtual:batchDelete",
  "rule:virtual:batchEnable",
  "rule:virtual:batchDisable",
  "rule:virtual:import",
  "rule:virtual:export",
  // "manage:role:add",
